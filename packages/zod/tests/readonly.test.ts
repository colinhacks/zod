...
test("flat inference", () => {
  core.assertEqual<z.infer<(typeof schemas)[0]>, string>(true);
  core.assertEqual<z.infer<(typeof schemas)[1]>, number>(true);
  core.assertEqual<z.infer<(typeof schemas)[2]>, number>(true);
  core.assertEqual<z.infer<(typeof schemas)[3]>, bigint>(true);
  core.assertEqual<z.infer<(typeof schemas)[4]>, boolean>(true);
  core.assertEqual<z.infer<(typeof schemas)[5]>, Date>(true);
  core.assertEqual<z.infer<(typeof schemas)[6]>, undefined>(true);
  core.assertEqual<z.infer<(typeof schemas)[7]>, null>(true);
  core.assertEqual<z.infer<(typeof schemas)[8]>, any>(true);
  core.assertEqual<z.infer<(typeof schemas)[9]>, Readonly<unknown>>(true);
  core.assertEqual<z.infer<(typeof schemas)[10]>, void>(true);
  core.assertEqual<
    z.infer<(typeof schemas)[11]>,
    (args_0: string, args_1: number, ...args_2: unknown[]) => unknown
  >(true);
  core.assertEqual<z.infer<(typeof schemas)[12]>, readonly string[]>(true);

  core.assertEqual<z.infer<(typeof schemas)[13]>, readonly [string, number]>(
    true
  );
  core.assertEqual<z.infer<(typeof schemas)[14]>, ReadonlyMap<string, Date>>(
    true
  );
  core.assertEqual<z.infer<(typeof schemas)[15]>, ReadonlySet<Promise<string>>>(
    true
  );
  core.assertEqual<
  ...
  >(true);
  core.assertEqual<z.infer<(typeof schemas)[19]>, Readonly<testEnum>>(true);
  core.assertEqual<z.infer<(typeof schemas)[20]>, Promise<string>>(true);
});

// test("deep inference", () => {
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[0]>, string>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[1]>, number>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[2]>, number>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[3]>, bigint>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[4]>, boolean>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[5]>, Date>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[6]>, undefined>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[7]>, null>(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[8]>, any>(true);
//   core.assertEqual<
//     z.infer<(typeof deepReadonlySchemas_0)[9]>,
//     Readonly<unknown>
//   >(true);
//   core.assertEqual<z.infer<(typeof deepReadonlySchemas_0)[10]>, void>(true);
//   core.assertEqual<
