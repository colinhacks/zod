...
export type { output, input, output as TypeOf, output as infer };
...
export interface ZodTypeDef extends $ZodTypeDef {}
...
export abstract class ZodType<
  ...
  Input = unknown,
> extends $ZodType<Output, Input> {
  // override readonly _def!: ZodTypeDef;
  ...
  constructor(public override _def: ZodTypeDef) {
    super(_def);
...
export class ZodString extends ZodType<string, string> {
  constructor(public override _def: ZodStringDef) {
    super(_def);
  }
  "~parse"(input: ParseInput, _ctx?: ParseContext): ParseReturnType<string> {
    if (this._def.coerce) {
...
export class ZodNumber extends ZodType<number, number> {
  constructor(public override _def: ZodNumberDef) {
    super(_def);
  }
  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<number> {
    if (this._def.coerce) {
      input = Number(input);
    }
...
export class ZodBigInt extends ZodType<bigint, bigint> {
  constructor(public override _def: ZodBigIntDef) {
    super(_def);
  }

  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<bigint> {
    if (this._def.coerce) {
      input = BigInt(input);
    }
    const parsedType = getParsedType(input);
...
export class ZodBoolean extends ZodType<boolean, boolean> {
  constructor(public override _def: ZodBooleanDef) {
    super(_def);
  }
  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<boolean> {
    if (this._def.coerce) {
      input = Boolean(input);
    }
    const parsedType = getParsedType(input);
...
export class ZodDate extends ZodType<Date, Date> {
  constructor(public override _def: ZodDateDef) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodSymbol extends ZodType<symbol, symbol> {
  constructor(public override _def: ZodSymbolDef) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodUndefined extends ZodType<undefined, undefined> {
  constructor(public override _def: ZodUndefinedDef) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodNull extends ZodType<null, null> {
  constructor(public override _def: ZodNullDef) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodAny extends ZodType<any, any> {
  constructor(public override _def: ZodAnyDef) {
    super(_def);
  }
...
export class ZodUnknown extends ZodType<unknown, unknown> {
  constructor(public override _def: ZodUnknownDef) {
    super(_def);
  }
  // required
...
export class ZodNever extends ZodType<never, never> {
  constructor(public override _def: ZodNeverDef) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodVoid extends ZodType<void, void> {
  constructor(public override _def: ZodVoidDef) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
> extends ZodType<
  ...
  Cardinality extends "atleastone"
    ...
    : T["~input"][]
> {
  constructor(public override _def: ZodArrayDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
    ...
    const results = parseResults as SyncParseReturnType<any>[];
...
> extends ZodType<Output, Input> {
  constructor(public override _def: ZodObjectDef<T, UnknownKeys, Catchall>) {
    super(_def);
  }
...
export class ZodUnion<T extends ZodUnionOptions> extends ZodType<
  ...
  T[number]["~input"]
> {
  constructor(public override _def: ZodUnionDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
> extends ZodType<output<Options[number]>, input<Options[number]>> {
  constructor(
...
> extends ZodType<T["~output"] & U["~output"], T["~input"] & U["~input"]> {
  constructor(public override _def: ZodIntersectionDef<T, U>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
> {
  constructor(public override _def: ZodTupleDef<T, Rest>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
> {
  constructor(public override _def: ZodRecordDef<Key, Value>) {
    super(_def);
  }
  get keySchema(): Key {
...
> {
  constructor(public override _def: ZodMapDef<Key, Value>) {
    super(_def);
  }
  get keySchema(): Key {
    return this._def.keyType;
...
export class ZodSet<Value extends ZodTypeAny = ZodTypeAny> extends ZodType<
  ...
  Set<Value["~input"]>
> {
  constructor(public override _def: ZodSetDef<Value>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
> {
  constructor(public override _def: ZodFunctionDef<Args, Returns>) {
    super(_def);
  }
  "~parse"(input: ParseInput, ctx: ParseContext): ParseReturnType<any> {
    const parsedType = getParsedType(input);
...
export class ZodLazy<T extends ZodTypeAny> extends ZodType<
  ...
  input<T>
> {
  constructor(public override _def: ZodLazyDef<T>) {
    super(_def);
  }
  get schema(): T {
...
export class ZodLiteral<T> extends ZodType<T, T> {
  constructor(public override _def: ZodLiteralDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodEnum<T extends [string, ...string[]]> extends ZodType<
  ...
  T[number]
> {
  constructor(public override _def: ZodEnumDef<T>) {
    super(_def);
  }
...
export class ZodNativeEnum<T extends EnumLike> extends ZodType<
  ...
  T[keyof T]
> {
  constructor(public override _def: ZodNativeEnumDef<T>) {
    super(_def);
  }
  #cache: Set<T[keyof T]> | undefined;
  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<T[keyof T]> {
...
export class ZodFile extends ZodType<File, File> {
  constructor(public override _def: ZodFileDef) {
    super(_def);
  }
  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<File> {
    const parsedType = getParsedType(input);
...
export class ZodPromise<T extends ZodTypeAny> extends ZodType<
  ...
  Promise<T["~input"]>
> {
  constructor(public override _def: ZodPromiseDef<T>) {
    super(_def);
  }
  unwrap(): T {
    return this._def.type;
...
export class ZodEffects<
  ...
  Input = input<T>,
> extends ZodType<Output, Input> {
  constructor(public override _def: ZodEffectsDef<T>) {
    super(_def);
  }
  innerType(): T {
...
export class ZodOptional<T extends ZodTypeAny> extends ZodType<
  ...
  T["~input"] | undefined
> {
  constructor(public override _def: ZodOptionalDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodNullable<T extends ZodTypeAny> extends ZodType<
  ...
  T["~input"] | null
> {
  constructor(public override _def: ZodNullableDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export interface ZodDefaultDef<T extends ZodTypeAny = ZodTypeAny>
  extends ZodTypeDef {
  innerType: T;
  defaultValue: () => util.noUndefined<T["~input"]>;
  typeName: ZodFirstPartyTypeKind.ZodDefault;
}
...
export class ZodDefault<T extends ZodTypeAny> extends ZodType<
  ...
  T["~input"] | undefined
> {
  constructor(public override _def: ZodDefaultDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
  ...
  static create<T extends ZodTypeAny>(
    type: T,
    params: RawCreateParams & {
      default: T["~input"] | (() => util.noUndefined<T["~input"]>);
    }
  ): ZodDefault<T> {
    return new ZodDefault({
      innerType: type,
...
export interface ZodCatchDef<T extends ZodTypeAny = ZodTypeAny>
  extends ZodTypeDef {
  innerType: T;
  catchValue: (ctx: { error: ZodError; input: unknown }) => T["~input"];
  typeName: ZodFirstPartyTypeKind.ZodCatch;
}
...
> {
  constructor(public override _def: ZodCatchDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodNaN extends ZodType<number, number> {
  constructor(public override _def: ZodNaNDef) {
    super(_def);
  }
  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<any> {
    const parsedType = getParsedType(input);
...
> extends ZodType<T["~output"] & BRAND<B>, T["~input"]> {
  constructor(public override _def: ZodBrandedDef<T>) {
    super(_def);
  }
  "~parse"(input: ParseInput, ctx: ParseContext): ParseReturnType<any> {
...
> extends ZodType<B["~output"], A["~input"]> {
  constructor(public override _def: ZodPipelineDef<A, B>) {
    super(_def);
  }
  "~parse"(input: ParseInput, ctx: ParseContext): ParseReturnType<any> {
...
> {
  constructor(public override _def: ZodReadonlyDef<T>) {
    super(_def);
  }
  "~parse"(
    input: ParseInput,
...
export class ZodTemplateLiteral<Template extends string = ""> extends ZodType<
  ...
  Template
> {
  constructor(public override _def: ZodTemplateLiteralDef) {
    super(_def);
  }
  ...
  "~parse"(input: ParseInput, _ctx: ParseContext): ParseReturnType<Template> {
    if (this._def.coerce) {
      input = String(input);
    }
