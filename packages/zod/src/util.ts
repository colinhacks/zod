...
// export type ZodErrorMap<T extends core.$ZodIssueBase = core.$ZodIssueBase> =
//   core.$ZodErrorMap<T>;
...
//   error?: string | ZodErrorMap<never> | undefined;
...
// > = Omit<T, "error"> & {
//   error?: ZodErrorMap<core.$ZodIssueBase> | undefined;
//   // description?: string | undefined;
// };
