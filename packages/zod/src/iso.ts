...
export function datetime(checks?: core.$ZodCheck<string>[]): schemas.ZodISODateTime;
...
export function date(params?: string | ZodISODateParams, checks?: core.$ZodCheck<string>[]): schemas.ZodISODate;
...
export function time(params?: string | ZodISOTimeParams, checks?: core.$ZodCheck<string>[]): schemas.ZodISOTime;
...
export function duration(checks?: core.$ZodCheck<string>[]): schemas.ZodISODuration;
