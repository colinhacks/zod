...
All Zod schemas (with some specific exceptions described below) are "codecs". More specifically, they can process inputs in both a forward and backward directions: 
