...
<img src="/codecs.png" alt="Codec directionality diagram showing bidirectional transformation between input and output schemas" />
...
This also provides the "safe" and "async" variantes you are accustomed to:
