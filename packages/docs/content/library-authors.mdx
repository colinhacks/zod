...
If you'd already implemented Zod 4 support according to the best practices described below (e.g. `"zod/v3/core"` subpath), then no other code changes should be necessary. This should not require a major version bump in your library.
</Callout>
