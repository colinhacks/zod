...
z.ipv4Range("192.168.1.0/24");  // ipv4 range validation
z.ipv6Range("2001:db8::/32");   // ipv6 range validation
...
Validate that an IP address falls within a specified CIDR range.

```ts
const schema = z.ipv4Range("192.168.1.0/24");
schema.parse("192.168.1.10");   // ✅
schema.parse("192.168.2.10");   // ❌ out of range

const v6Schema = z.ipv6Range("2001:db8::/32");
v6Schema.parse("2001:db8::1");  // ✅
v6Schema.parse("2001:db9::1");  // ❌ out of range
```
