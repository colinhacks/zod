...
To allow any string, but prefer a fixed set of values:

```ts
const FishEnum = z.looseEnum(["Salmon", "Tuna", "Trout"]);

FishEnum.parse("Salmon");     // => "Salmon"
FishEnum.parse("Swordfish");  // => "Swordfish" ✅ unknowns allowed
FishEnum.parse(123);          // ❌ only strings allowed

type FishEnum = z.infer<typeof FishEnum>;
// => "Salmon" | "Tuna" | "Trout" | (string & {})
```
