...
datetime.parse("2020-01-01T00:00:00+02:00"); // ❌ (offsets not allowed)
datetime.parse("2020-01-01T00:00:00"); // ❌ (local not allowed)
```
...
time.parse("03:15"); // ✅ normalizes to `09:52:00`
