...
For a detailed writeup on the reasons for this versioning schema, refer to [this writeup](https://github.com/colinhacks/zod/issues/4371). For a complete list of breaking changes, refer to the [Migration guide](/v4/changelog). This post focuses on new features & enhancements.
