...
Zod 4 is now in beta after over a year of active development. It's faster, slimmer, more `tsc`-efficient, and implements some long-requested features, including an new `@zod/mini` library.
...
<Callout icon="❤️"> 
Huge thanks to [Clerk](https://go.clerk.com/zod-clerk), who my work on Zod 4 through their extremely generous [OSS Fellowship](https://clerk.com/blog/zod-fellowship). They were an amazing partner throughout the (much longer than anticipated!) development process.
</Callout>
