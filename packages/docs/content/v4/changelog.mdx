...
A non-official codemod is available to help you migrate from Zod 3 to Zod 4: [zod-v3-to-v4](https://www.npmjs.com/package/zod-v3-to-v4)

Once you have upgraded to Zod 4, you can run the following to automatically migrate your code to the new API:

```
npx zod-v3-to-v4
```

> This codemod may not catch every case, but it should cover the majority of them. You may need to manually fix some errors.
