...
<Callout>
**Note** — If your schema uses certain asynchronous APIs like `async` [refinements](/api#refine) or [transforms](/api#transform), you'll need to use the `.parseAsync()` method instead. 
...
<Callout>
**Note** — If your schema uses certain asynchronous APIs like `async` [refinements](/api#refine) or [transforms](/api#transform), you'll need to use the `.safeParseAsync()` method instead. 
