...
<Callout>
If you already have a TypeScript type, you can use `satisfies` to check that your schema's output is assignable to it:
...
This is an assignability check, not an exact type equality check. In particular, extra object properties and omitted optional properties may still pass.
