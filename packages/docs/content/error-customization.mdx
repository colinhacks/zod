...
Import locales as named exports from `zod/v4` (fully tree-shakeable):

<Tabs groupId="lib" items={["Zod", "Zod Mini"]}>
<Tab value="Zod">
```ts
import * as z from "zod/v4";
import { de, fr } from "zod/v4"; // Import the locales you need
...
Locales are exported as **named exports** for optimal tree-shaking. Only the locales you import will be included in your bundle:

```ts
import * as z from "zod/v4";
import { de, fr, ja } from "zod/v4"; // Only these 3 locales bundled

// Default bundle: ~24KB (core + English)
