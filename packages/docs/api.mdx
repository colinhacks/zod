...
To allow multiple possible literal values:
...
This uses a relatively strict email regex. 

By default, Zod uses a relatively simple regular expression to validate email addresses. It's the 
