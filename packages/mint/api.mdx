...
<CodeGroup onChange={(e)=>{console.log(e)}} onCopied={()=>{console.log("copy")}}> 
...
Zod aims to mirror TypeScript's type system one-to-one. As such, Zod provides APIs to represent certain special types.
