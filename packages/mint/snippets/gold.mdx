      ...
      <div className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 rounded-md">
        <div className="grid grid-cols-1 sm:grid-cols-2">
          {companies.map((company) => (
            <div 
              key={company.name} 
              className="p-4 flex flex-col items-center border-b border-gray-200 dark:border-gray-700 last:border-b-0 border-b border-r"
            >
              <a href={company.href} target="_blank" rel="noopener noreferrer" className="m-0 border-none">
                <img
                  src={company.logoLight}
                  alt={`${company.name} logo (light theme)`} 
                  className="m-0 h-16 object-contain dark:hidden"
                />
                <img 
                  src={company.logoDark}
                  alt={`${company.name} logo (dark theme)`} 
                  className="m-0 h-16 object-contain hidden dark:block"
                />
              </a>
