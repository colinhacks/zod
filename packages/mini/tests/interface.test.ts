...
test("optionals", () => {
  ...
  expectTypeOf<typeof a._zod.input>().toEqualTypeOf<a_in>();
...
test("one to one", () => {
  ...
  expectTypeOf<(typeof A._zod.output)["b"]["a"]["b"]["name"]>().toEqualTypeOf<string>();
  expectTypeOf<(typeof A._zod.input)["b"]>().toEqualTypeOf<B | undefined>();
});
...
test("one to many", () => {
  ...
  // ._zod.outputC.d.c.d.c.d;
  // expectTypeOf<(typeof C)["_def"]["shape"]>().toEqualTypeOf<z.ZodMiniShape>();
  expectTypeOf<typeof C._zod.output>().toEqualTypeOf<_C>();
  expectTypeOf<(typeof D._zod.output)["c"]["d"][number]>().toEqualTypeOf<_D>();
});
...
test("many to many", () => {
  ...
  expectTypeOf<typeof E._zod.output>().toEqualTypeOf<_E>();
  expectTypeOf<(typeof F._zod.output)["e"][number]>().toEqualTypeOf<_E>();
});
...
test("self recursive", () => {
  ...
  expectTypeOf<(typeof E._zod.output)["e"]["e"]["e"]>().toEqualTypeOf<_E>();
  E;
});
...
test("self recursive optional", () => {
  ...
  expectTypeOf<typeof F._zod.output>().toEqualTypeOf<_F>();
