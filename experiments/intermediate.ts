...
function validateString(this: $ZSFString, input: unknown, ctx?: parse.ParseContext): ParseResult<string> {
...
class $ZodNumber extends $ZodTypeExtended<number, number> implements $ZSFNumber {
  min: number;
  max: number;
