...
const doubleLargeNestedSuite = new Benchmark.Suite("z.discriminatedUnion: double large nested");
const manyLargeNestedSuite = new Benchmark.Suite("z.discriminatedUnion: many large nested");
...
const doubleLargeNested = z.discriminatedUnion("type", [aLargeNestedSchema, bLargeNestedSchema]);
const many = z.discriminatedUnion("type", [aSchema, bSchema, cSchema, dSchema]);
const manyLargeNested = z.discriminatedUnion("type", [aLargeNestedSchema, bLargeNestedSchema, cLargeNestedSchema, dLargeNestedSchema]);
